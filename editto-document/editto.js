...
function eDittoDocument(textid, editor) {
    ...
    editBox.onload = function() {
        $this.frame = $this.getIframeDocument();
        $this.permitirEdicao();
    };
    ...
    this.getIframeDocument = function(aID) {
        if (editBox.contentWindow) {
            return editBox.contentWindow.document;

        } else {
      // se contentDocument existe
          if (editBox.contentDocument) {
            return editBox.contentDocument;
          } else {
            if (document.frames['t' + textid].document) {
                // IE
